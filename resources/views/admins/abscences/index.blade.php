...
<section class="content-header">
        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Ajouter une nouvelle abscence</h5>
        ...
        <!--  -->
     <ol class="breadcrumb">
       <li><a href="{{ url('/admin') }}"><i class="fa fa-dashboard"></i> Gestion des contrats </a></li>
       <li class="active"><a href="{{ url('/admin') }}"> Abscences</a></li>
     </ol>
   </section>
     ...
     <div class="row">
       <div class="col-xs-12 ">
         ...
         <div class="box-header with-border">
              <h3 class="box-title">Liste des abscences</h3>
